  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Retrouvez-nous</h2>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <div className="flex-1 text-center sm:text-left">
                  <p className="font-medium flex items-center justify-center sm:justify-start mb-1">
