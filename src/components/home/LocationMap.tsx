...
const LocationMap = () => {
  ...
  return <section className="px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold">Retrouvez-nous</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.5
            ...
            <Card className="overflow-hidden shadow-md border-none">
              <CardContent className="p-0">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2891.5429189232896!2d6.937453375869258!3d43.55261895887715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12ce8c1320fbf0a5%3A0xe901e493c9a1b4d8!2s42%20Chem.%20de%20l&#39;Escadrille%2C%2006210%20Mandelieu-la-Napoule!5e0!3m2!1sfr!2sfr!4v1718458531594!5m2!1sfr!2sfr" width="100%" height="450" style={{
                border: 0
              }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Google Maps - BIG IMEX location" className="rounded-lg"></iframe>
              </CardContent>
            </Card>
          </motion.div>
          <motion.div initial={{
          ...
          duration: 0.5
            ...
            <div className="space-y-6">
              ...
              scale: 1.02
            }} className="flex items-center space-x-4 p-5 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors duration-200 shadow-sm hover:shadow-md" onClick={handleOpenGoogleMaps}>
