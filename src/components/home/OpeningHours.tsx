...
const OpeningHours = () => {
  return <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto">
        ...
        duration: 0.5
          ...
          <h2 className="font-semibold mb-6 sm:mb-8 text-2xl sm:text-3xl text-inherit">Horaires d'ouverture</h2>
