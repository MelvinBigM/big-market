          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-5 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                  <div className="h-12 w-12 flex-shrink-0 flex items-center justify-center bg-primary/10 rounded-full">
                    <MapPin className="w-6 h-6 text-primary" />
                  </div>
                  <div className="flex-1">
                    <p className="font-medium mb-1 text-center">Adresse</p>
                ...
                <div className="flex items-start space-x-4 p-5 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1 text-center">Téléphone</p>
                    <div className="text-center">
                ...
                <div className="flex items-start space-x-4 p-5 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1 text-center">Email</p>
                    <div className="text-center">
